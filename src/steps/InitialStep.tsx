  ...
  return (
    <div className="grow flex flex-col justify-center items-center">
      <button
        ...
        className="bg-blue-400 dark:bg-blue-600 text-blue-900 dark:text-blue-100 text-6xl font-semibold px-7 py-4 rounded-full transition ease-in-out hover:brightness-90 hover:scale-110"
      >
        START
      </button>
